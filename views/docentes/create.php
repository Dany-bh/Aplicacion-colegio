...
<div class="card">
    <div class="card-header">
        <h2 class="card-title">Registrar Nuevo Docente</h2>
    </div>
    <div class="card-body">
        <form action="index.php?controller=docente&action=store" method="POST">
            ...
            <fieldset class="border p-3 mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" class="form-control" id="anio_ingreso" name="anio_ingreso" min="1980" max="<?php echo date('Y'); ?>" value="<?php echo date('Y'); ?>">
                    </div>
                     <div class="col-md-3 mb-3">
